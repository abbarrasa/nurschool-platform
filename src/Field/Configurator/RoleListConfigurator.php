...
namespace Nurschool\Field\Configurator;
...
class RoleListConfigurator implements FieldConfiguratorInterface
{
    private $translator;
    ...
    {
        return RoleListField::class === $field->getFieldFqcn();
    }
    ...
    public function configure(FieldDto $field, EntityDto $entityDto, AdminContext $context): void
    {
        ...
        $selectedChoices = [];
        $flippedChoices = array_flip(RoleListType::CHOICES);
